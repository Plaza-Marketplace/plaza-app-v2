...
import { communityReportSchema, videoReportSchema } from '../yupSchemas';
import BodyText from '@/components/Texts/BodyText';
import Color from '@/constants/Color';
import ThankYou from '../components/ThankYou';
import { createCommunityReport, createProductReport } from '../services';
import { useAuth } from '@/contexts/AuthContext';

interface CommunityReportModalProps {
  // Define any props if needed
  communityId: Id;
  bottomSheetRef?: React.RefObject<BottomSheetModal>; // Adjust type as needed
}

const CommunityReportModal: FC<CommunityReportModalProps> = ({
  communityId,
  bottomSheetRef,
}) => {
  const { user } = useAuth();
  ...
  return (
    ...
    >
      ...
      >
        <HeadingText variant="h6-bold">Report Community</HeadingText>
        ...
        <Formik
          ...
          validationSchema={communityReportSchema}
        >
