...
import { createCommunityCollectionReport } from '../services';
...
const CollectionReportModal: FC<CollectionReportModalProps> = ({
  collectionId,
  bottomSheetRef,
  communityId,
}) => {
  ...
  return (
    ...
    >
      ...
      >
        <HeadingText variant="h6-bold">Report Collection Post</HeadingText>
