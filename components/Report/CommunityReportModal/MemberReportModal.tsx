...
import { videoReportSchema } from '../yupSchemas';
import BodyText from '@/components/Texts/BodyText';
import Color from '@/constants/Color';
import ThankYou from '../components/ThankYou';
import { createCommunityMemberReport } from '../services';
...
const MemberReportModal: FC<MemberReportModalProps> = ({
  memberId,
  bottomSheetRef,
  ...
  return (
    ...
    >
      ...
      >
        <HeadingText variant="h6-bold">Report Member</HeadingText>
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            try {
              await createCommunityMemberReport({
          ...
          validationSchema={videoReportSchema}
        >
